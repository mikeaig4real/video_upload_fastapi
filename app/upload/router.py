...
async def get_params(
    ...
    """TODO:
    1. Save some residue data incase the process is not completed properly
    2. Schedule a background task in advance with retries, use upload_status to check if upload was complete
    if true, kill task
